...
Write-Host ""
Write-Host "완료: $root\$Output\ClaudeUsageMonitor.App.exe"
Get-Item "$Output\ClaudeUsageMonitor.App.exe" | Select-Object Name, @{N = "SizeMB"; E = { [Math]::Round($_.Length / 1MB, 1) } }
